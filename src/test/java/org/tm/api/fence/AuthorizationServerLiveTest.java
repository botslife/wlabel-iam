...
public class AuthorizationServerLiveTest {
    ...
    public static final String AUTHORIZE_CODE_URL = "http://localhost:8083/auth/realms/fencedev/protocol/openid-connect/auth?response_type=code&client_id=restClientId&scope=read&redirect_uri=";
    public static final String TOKEN_URL = "http://localhost:8083/auth/realms/fencedev/protocol/openid-connect/token";
    public static final String INTROSPECT_URL = "http://localhost:8083/auth/realms/fencedev/protocol/openid-connect/token/introspect";
    public static final String USER_INFO_URL = "http://localhost:8083/auth/realms/fencedev/protocol/openid-connect/userinfo";

    public static final String JWT_CLIENT_SECRET = "90ef3dc6-fce2-4e61-885f-22268e0418d3";
    public static final String JWT_CLIENT = "restClientId";
    public static final String REDIRECT_URL = "http://localhost:8088/";

    public static final String USERNAME = "raja";
    public static final String PASSWORD = "raja";
    public static final String OIDC_DISCOVERY_URL = "http://localhost:8083/auth/realms/fencedev/.well-known/openid-configuration";
    ...
    public void givenRefreshTokenGrantAndValidRefreshToken_whenObtainAccess_thenSuccess() {
        ...
        final String tokenUrl = "http://localhost:8083/auth/realms/fencedev/protocol/openid-connect/token";
